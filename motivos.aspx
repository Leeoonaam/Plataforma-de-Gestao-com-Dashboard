<%@ Page Title="Usuários | STT - GAT Link " Language="C#" MasterPageFile="~/MasterPageGATLink.master" AutoEventWireup="true" CodeFile="usuarios - Copy.aspx.cs" Inherits="usuarios" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="page-title">
        ...
        <div class="page-breadcrumb">
            <ol class="breadcrumb">
                <li><a href="usuarios.aspx">Home</a></li>
                <li class="active">Gerenciador de Usuários</li>
            </ol>
        </div>
    </div>
                ...
                <div class="panel panel-white ui-sortable-handle" style="opacity: 1;">
                    ...
                    <div class="panel-body" style="display: block;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="m-b-sm">
                                    <asp:TextBox ID="txtlogin_filtro" CssClass="form-control" runat="server"></asp:TextBox>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="m-b-sm">
                                   <asp:TextBox ID="txtmatricula_filtro" CssClass="form-control" runat="server"></asp:TextBox>
                                </div>
                            </div>
                        </div>
