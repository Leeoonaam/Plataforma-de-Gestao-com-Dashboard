<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageGATLink.master" AutoEventWireup="true" CodeFile="monitorar_servicos_netsms.aspx.cs" Inherits="monitorar_servicos_netsms" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="page-title">
        <h3>Serviço RPA Cancelamento NET SMS</h3>
        <div class="page-breadcrumb">
            <ol class="breadcrumb">
                <li><a href="dashboard.aspx">Home</a></li>
                <li class="active">Serviço RPA Cancelamento NET SMS</li>
            </ol>
        </div>
    </div>
                                ...
                                <div class="panel info-box panel-white">
                                    <div class="panel-body">
                                        <div class="info-box-stats">
                                            <p>
                                                <a style="text-decoration: none; color: black;" href="detalhes_rpa.aspx?_scampanha=<%=_scampanha%>&_sperfil=<%=_sperfil%>&_sequipe=<%=_sequipe%>&_susuario=<%=_susuario%>&_sdtini=<%=_sdtini%>&_sdtfim=<%=_sdtfim%>&_socorrencia=<%=_socorrencia%>&_scontrato=<%=_scontrato%>&_scampanhaBKO=<%=_scampanhabko%>&_sstatusbpm=0&_sidstatusnetsms=4" target="_blank">
                                                    <span class="counter">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="panel info-box panel-white">
                                    <div class="panel-body">
                                        <div class="info-box-stats">
                                            <p>
                                                <a style="text-decoration: none; color: black;" href="detalhes_rpa.aspx?_scampanha=<%=_scampanha%>&_sperfil=<%=_sperfil%>&_sequipe=<%=_sequipe%>&_susuario=<%=_susuario%>&_sdtini=<%=_sdtini%>&_sdtfim=<%=_sdtfim%>&_socorrencia=<%=_socorrencia%>&_scontrato=<%=_scontrato%>&_scampanhaBKO=<%=_scampanhabko%>&_sstatusbpm=0&_sidstatusnetsms=1" target="_blank">
                                                    <span class="counter">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="panel info-box panel-white">
                                    <div class="panel-body">
                                        <div class="info-box-stats">
                                            <p>
                                                <a style="text-decoration: none; color: black;" href="detalhes_rpa.aspx?_scampanha=<%=_scampanha%>&_sperfil=<%=_sperfil%>&_sequipe=<%=_sequipe%>&_susuario=<%=_susuario%>&_sdtini=<%=_sdtini%>&_sdtfim=<%=_sdtfim%>&_socorrencia=<%=_socorrencia%>&_scontrato=<%=_scontrato%>&_scampanhaBKO=<%=_scampanhabko%>&_sstatusbpm=0&_sidstatusnetsms=2" target="_blank">
                                                    <span class="counter">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="panel info-box panel-white">
                                    <div class="panel-body">
                                        <div class="info-box-stats">
                                            <p>
                                                <a style="text-decoration: none; color: black;" href="detalhes_rpa.aspx?_scampanha=<%=_scampanha%>&_sperfil=<%=_sperfil%>&_sequipe=<%=_sequipe%>&_susuario=<%=_susuario%>&_sdtini=<%=_sdtini%>&_sdtfim=<%=_sdtfim%>&_socorrencia=<%=_socorrencia%>&_scontrato=<%=_scontrato%>&_scampanhaBKO=<%=_scampanhabko%>&_sstatusbpm=0&_sidstatusnetsms=3" target="_blank">
                                                    <span class="counter">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="panel info-box panel-white">
                                    <div class="panel-body">
                                        <div class="info-box-stats">
                                            <p>
                                                <a style="text-decoration: none; color: black;" href="detalhes_rpa.aspx?_scampanha=<%=_scampanha%>&_sperfil=<%=_sperfil%>&_sequipe=<%=_sequipe%>&_susuario=<%=_susuario%>&_sdtini=<%=_sdtini%>&_sdtfim=<%=_sdtfim%>&_socorrencia=<%=_socorrencia%>&_scontrato=<%=_scontrato%>&_scampanhaBKO=<%=_scampanhabko%>&_sstatusbpm=0&_sidstatusnetsms=6" target="_blank">
                                                    <span class="counter">
