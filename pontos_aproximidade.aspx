<%@ Page Language="C#" Title="Pontos de Proximidade | STT - GAT Link" MasterPageFile="~/MasterPageGATLink.master" AutoEventWireup="true" CodeFile="pontos_aproximidade.aspx.cs" Inherits="pontos_aproximados" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="page-title">
        <h3>Gerenciador de Pontos Próximos</h3>
        <div class="page-breadcrumb">
            <ol class="breadcrumb">
                <li><a href="dashboard.aspx">Home</a></li>
                <li class="active">Gerenciador de Pontos Próximos</li>
            </ol>
        </div>
    </div>
