<%@ Page Language="C#" AutoEventWireup="true" CodeFile="detalhes_rpa.aspx.cs" Inherits="detalhes_rpa" %>
                    ...
                    <div class="col-lg-12">
                        ...
                        <asp:Panel ID="panel_grd_dados" Width="100%" Height="500px" ScrollBars="Auto" Visible="true" runat="server">
                            ...
                            <asp:GridView ID="gdw_dados" CssClass="table table-striped table-bordered table-hover"
                                ...
                                Width="100%" AutoGenerateColumns="False" DataKeyNames="IDCodCliente"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="IDCODCLIENTE" HeaderText="ID.Cliente" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="CAMPANHA" HeaderText="Campanha" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="CONTRATO" HeaderText="Contrato" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="FILA" HeaderText="Fila" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="status_atendimento" HeaderText="Status" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="motivo" HeaderText="Motivo" ItemStyle-HorizontalAlign="Left" />
                                    ...
                                    <asp:BoundField DataField="data_rpa_cancelamento" HeaderText="Data.Status.RPA" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="data_ini_process_rpa_cancelamento" HeaderText="Ini.Process.RPA" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="data_fim_process_rpa_cancelamento" HeaderText="Fim.Process.RPA" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="obs_rpa_cancelamento" HeaderText="Detalhe.Processo.NETSMS" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="DATAINSERCAO" HeaderText="Data.Inserção" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="TMT" HeaderText="Tempo.Process" ItemStyle-HorizontalAlign="Left" />
