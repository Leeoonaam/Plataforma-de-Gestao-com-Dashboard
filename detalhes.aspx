...
<body>
    ...
    <form id="frmdetalhes" runat="server">
        ...
        <div class="page-title" style="background-color:#6B1846;">
            <h3 style=" color:white;">Detalhes do Registro</h3>
        </div>
                        ...
                        <asp:Panel ID="panel_grd_dados" Width="100%" Height="500px" ScrollBars="Auto" Visible="true" runat="server">
                            ...
                            <asp:GridView ID="gdw_dados" CssClass="table table-striped table-bordered table-hover"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="img" HeaderText="Mapa" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="imgh" HeaderText="Hodômetro" ItemStyle-HorizontalAlign="Left" />
                                    ...
                                    <asp:BoundField DataField="data" HeaderText="Data Localização" ItemStyle-HorizontalAlign="Left" />
