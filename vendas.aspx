<%@ Page Title="Vendas | STT - GAT Link" MasterPageFile="~/MasterPageGATLink.master" Language="C#" AutoEventWireup="true" CodeFile="vendas.aspx.cs" Inherits="vendas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="page-title">
        <h3>Gerenciador de Vendas</h3>
        <div class="page-breadcrumb">
            <ol class="breadcrumb">
                <li><a href="vendas.aspx">Home</a></li>
                <li class="active">Gerenciador de Vendas</li>
            </ol>
        </div>
    </div>
                ...
                <div class="panel panel-white ui-sortable-handle" style="opacity: 1;">
                    ...
                    <div class="panel-body" style="display: block;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="m-b-sm">
                                <asp:TextBox ID="txtcliente_filtro" CssClass="form-control" runat="server"></asp:TextBox>    
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- tipo venda -->
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Tipo Venda:</label>
                            <div class="col-sm-10">
                                <div class="m-b-sm">
                                    <asp:ListBox ID="cmbtipovenda_filtro" runat="server" CssClass="show-tick form-control" SelectionMode="single">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="m-b-sm">
                                    <asp:ListBox ID="cmbtipocliente_filtro" runat="server" CssClass="show-tick form-control" SelectionMode="single">
                                        <asp:ListItem Value="">Selecione:</asp:ListItem>
                                    </asp:ListBox>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="text-right">
                                <%--<asp:Button ID="cmdlimpar_filtro" runat="server" CssClass="btn btn-success" Text="Limpar" autopostback="false" OnClick="limpacampos();return false;" />--%>
                                <button type="button" id="cmdlimpar_filtro" onclick="limpacampos();" style="font-size:14px" class="btn btn-success">Limpar</button>
                            </div>
                        </div>
