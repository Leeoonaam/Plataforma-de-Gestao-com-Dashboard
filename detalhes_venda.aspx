<%@ Page Language="C#" AutoEventWireup="true" CodeFile="detalhes_venda.aspx.cs" Inherits="detalhes_venda" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Detalhes Venda | STT GAT Link</title>
...
<body>
    ...
    <form id="frmdetalhes" runat="server">
        ...
        <div class="page-title" style="background-color:#6B1846;">
            <h3 style=" color:white;">Detalhes da Venda</h3>
        </div>
                        ...
                        <asp:Panel ID="panel_grd_dados" Width="100%" Height="500px" ScrollBars="Auto" Visible="true" runat="server">
                            ...
                            <asp:GridView ID="gdw_dados" CssClass="table table-striped table-bordered table-hover"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="IdCodVenda" HeaderText="ID" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="TipoVenda" HeaderText="Tipo Venda" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="data" HeaderText="Data da Venda" ItemStyle-HorizontalAlign="Left" />
                                    ...
                                    <asp:BoundField DataField="TipoMaquina_Point" HeaderText="Tipo de Máquina" ItemStyle-HorizontalAlign="Left" />	
                                    <asp:BoundField DataField="NumeroControle_Point" HeaderText="Número de Controle" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="FormaPagamento_Point" HeaderText="Forma de Pagamento" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="Foto_Point" HeaderText="Fotos" ItemStyle-HorizontalAlign="Left" />	
                                    <asp:BoundField DataField="statusvendaqr" HeaderText="Status da Venda" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="CadatroPix_QR" HeaderText="Cadastro do Pix" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="PossuiConta_QR" HeaderText="Cliente Possui conta Mercado Pado" ItemStyle-HorizontalAlign="Left" />	
                                    <asp:BoundField DataField="Email_QR" HeaderText="E-mail" ItemStyle-HorizontalAlign="Left" />

                                    <asp:BoundField DataField="check" HeaderText="Tipo Check" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="TPV_Prometido" HeaderText="TPV Prometido" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="Nome_Responsavel" HeaderText="Nome Resp." ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="Telefone_Responsavel" HeaderText="Telefone Resp." ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="Email_MercadoPago" HeaderText="E-mail Mercado Pago" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="Numero_Operacao1" HeaderText="Num. Operação 1" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="Numero_Operacao2" HeaderText="Num. Operação 2" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="Numero_Operacao3" HeaderText="Num. Operação 3" ItemStyle-HorizontalAlign="Left" />
                                    ...
                                    <asp:BoundField DataField="vendedor" HeaderText="Vendedor" ItemStyle-HorizontalAlign="Left" />
