<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeFile="rotas_dados.aspx.cs" Inherits="rotas_dados" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Dados da Rota | STT - GAT Link</title>
    ...
    <script>
        ...
        function initMap() {
            ...
            var map1 = new google.maps.Map(document.getElementById('mapa'), { zoom: 8, center: uluru1 });// { zoom: 4, center: uluru });
        ...
        function initMap2(){
            ...
            var map2 = new google.maps.Map(document.getElementById('map2'), { zoom: 8, center: uluruMap });// { zoom: 4, center: uluru });
        ...
        function initMapGrid(){
            ...
            var map2 = new google.maps.Map(document.getElementById('map2'), { zoom: 15, center: uluruMap });// { zoom: 4, center: uluru });
        ...
        function AddRow() {
            ...
            if (document.getElementById("txtnomeendereco").value == "") {
                ...
                document.getElementById("alerta").innerHTML = "<strong><i class='fa fa-exclamation-triangle' aria-hidden='true'></i>&nbsp;Atenção !</strong> Preencha o Nome do Endereço!";
                return;
            }
            if (document.getElementById("txtEndereco").value == "") {
                document.getElementById("alerta").style = "display: visible;";
                document.getElementById("alerta").innerHTML = "<strong><i class='fa fa-exclamation-triangle' aria-hidden='true'></i>&nbsp;Atenção !</strong> Preencha o Endereço para Carregar a Latitude e Longitude!";
                return;
            }
        ...
        function PegaDadosGrid_E_UsuarioRelacionados(){
            ...
            // VARIAVEIS DOS USUARIOS RELACIONADOS
            var cmbrelacionados = document.getElementById('cmbRelacionados');
            var txtrelacionados = document.getElementById("txtItemsRelacionados");

            txtrelacionados.value = '';

            for (i = 0; i <= cmbrelacionados.options.length - 1; i++) {
                if (cmbrelacionados.options[i].selected == true) {
                    txtrelacionados.value = txtrelacionados.value + cmbrelacionados.options[i].value + ';';
                }
            }
        ...
        function FiltraEquipe(){
            var cmb = document.getElementById("<%=cmbEquipe.ClientID %>");
            cmb = cmb.getElementsByTagName('option');
            var txt = document.getElementById('txtValueEquipe');

            txt.value = '';

            for (var i = 0; i < cmb.length ; i++) {
                if (cmb.item(i).selected == true) {

                    if (txt.value != "") {
                        txt.value = txt.value + ",";
                    }
                    txt.value = txt.value + cmb.item(i).value;
                }
            }
        }

        function FiltraUsuario(){
            var cmb = document.getElementById("<%=cmbUsuarios_filtro.ClientID %>");
            cmb = cmb.getElementsByTagName('option');
            var txt = document.getElementById('txtvalueLogin');
...
<body style="background-color:white">
    ...
    <form id="frmrotas_dados" runat="server">
        ...
        <div class="page-title" style="background-color: #6B1846">
            <h3 style="color:white">Dados da Rota</h3>
        </div>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body" style="border-radius:10px; box-shadow: 0px 0px 1em #BBC0C8">
                    ...
                    <asp:HiddenField ID="txtItemsRelacionados" runat="server" />
                    <asp:HiddenField ID="txtItemsUsuarios" runat="server" />

                    <asp:HiddenField ID="txtDadosGrid" runat="server" />
                    <asp:HiddenField ID="txtValueEquipe" runat="server" />
                    <asp:HiddenField ID="txtvalueLogin" runat="server" />
                                    ...
                                    <table>
                                        <tr>
                                            <td style="width: 700px">
                                                <label>Login:</label>
                                                <asp:ListBox ID="cmbUsuarios_filtro" Height="50px" runat="server" AutoPostBack="false" CssClass="form-control" SelectionMode="Multiple"></asp:ListBox>
                                            </td>
                                            <td>&nbsp;</td>
                                            <td style="width: 700px">
                                                <label>Equipe:</label>
                                                <asp:ListBox ID="cmbEquipe" runat="server" CssClass="form-control" AutoPostBack="false" SelectionMode="Multiple"></asp:ListBox>
                                            </td>
                                        </tr>
                                    </table>
                                    &nbsp;
                                    <div class="text-right">
                                        <asp:Button ID="cmdFiltrar_equipe" CssClass="text-right btn btn-success new" runat="server" OnClientClick="FiltraEquipe(); FiltraUsuario();" OnClick="cmdFiltrar_equipe_Click" Text="Filtrar" />
                                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <p></p>
                            <button id="cmdAdicionarTodos" class="btn btn-success new" onclick="moveltodos(); return false;">>></button>
                            &nbsp;&nbsp;
                            <button id="cmdAdicionarSel" class="btn btn-success new" onclick="move1(); return false;">></button>
                            <p></p>
                            <asp:ListBox ID="cmbUsuarios" Height="50px" runat="server" AutoPostBack="false" CssClass="form-control" SelectionMode="Multiple"></asp:ListBox>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <p></p>
                            <button id="cmdRemoverSel" class="btn btn-success new" runat="server" onclick="move2(); return false;"><</button>
                            &nbsp;&nbsp;
                            <button id="cmdRemoverTodos" class="btn btn-success new" runat="server" onclick="moveltodos2(); return false;"><<</button>
                            <p></p>
                            <asp:ListBox ID="cmbRelacionados" Height="50px" runat="server" AutoPostBack="false" CssClass="form-control" SelectionMode="Multiple"></asp:ListBox>
                        </div>
                    ...
                    <div class="form-group">
                        <div role="tabpanel">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li role="presentation" class=""><a href="#tab2" role="tab" data-toggle="tab" aria-expanded="false">Mapa Roteiro</a></li>
                            </ul>
