<%@ Page Language="C#" Title="" MasterPageFile="~/MasterPageGATLink.master" AutoEventWireup="true" CodeFile="monitorar_servicos_netsms2.aspx.cs" Inherits="monitorar_servicos_netsms2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="page-title">
        <h3>Serviço RPA Cancelamento NET SMS - Outros Canais</h3>
        <div class="page-breadcrumb">
            <ol class="breadcrumb">
                <li><a href="dashboard.aspx">Home</a></li>
                <li class="active">Serviço RPA Cancelamento NET SMS - Outros Canais</li>
            </ol>
        </div>
    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="col-lg-12">
                            ...
                            <!--BLOCOS GERENCIAIS Total de registro-->
                            <div class="col-lg-3 col-md-6">
                                <div class="panel info-box panel-white">
                                    <div class="panel-body">
                                        <div class="info-box-stats">
                                            <p>
                                                <a style="text-decoration: none; color: black;" href="detalhes_rpa.aspx?_scampanha=<%=_scampanha%>&_sperfil=<%=_sperfil%>&_sequipe=<%=_sequipe%>&_susuario=<%=_susuario%>&_sdtini=<%=_sdtini%>&_sdtfim=<%=_sdtfim%>&_socorrencia=<%=_socorrencia%>&_scontrato=<%=_scontrato%>&_scampanhaBKO=<%=_scampanhabko%>&_sstatusbpm=-2&_sidstatusnetsms=4" target="_blank">
                                                    <span class="counter">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="panel info-box panel-white">
                                    <div class="panel-body">
                                        <div class="info-box-stats">
                                            <p>
                                                <a style="text-decoration: none; color: black;" href="detalhes_rpa.aspx?_scampanha=<%=_scampanha%>&_sperfil=<%=_sperfil%>&_sequipe=<%=_sequipe%>&_susuario=<%=_susuario%>&_sdtini=<%=_sdtini%>&_sdtfim=<%=_sdtfim%>&_socorrencia=<%=_socorrencia%>&_scontrato=<%=_scontrato%>&_scampanhaBKO=<%=_scampanhabko%>&_sstatusbpm=-2&_sidstatusnetsms=1" target="_blank">
                                                    <span class="counter">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="panel info-box panel-white">
                                    <div class="panel-body">
                                        <div class="info-box-stats">
                                            <p>
                                                <a style="text-decoration: none; color: black;" href="detalhes_rpa.aspx?_scampanha=<%=_scampanha%>&_sperfil=<%=_sperfil%>&_sequipe=<%=_sequipe%>&_susuario=<%=_susuario%>&_sdtini=<%=_sdtini%>&_sdtfim=<%=_sdtfim%>&_socorrencia=<%=_socorrencia%>&_scontrato=<%=_scontrato%>&_scampanhaBKO=<%=_scampanhabko%>&_sstatusbpm=-2&_sidstatusnetsms=2" target="_blank">
                                                    <span class="counter">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="panel info-box panel-white">
                                    <div class="panel-body">
                                        <div class="info-box-stats">
                                            <p>
                                                <a style="text-decoration: none; color: black;" href="detalhes_rpa.aspx?_scampanha=<%=_scampanha%>&_sperfil=<%=_sperfil%>&_sequipe=<%=_sequipe%>&_susuario=<%=_susuario%>&_sdtini=<%=_sdtini%>&_sdtfim=<%=_sdtfim%>&_socorrencia=<%=_socorrencia%>&_scontrato=<%=_scontrato%>&_scampanhaBKO=<%=_scampanhabko%>&_sstatusbpm=-2&_sidstatusnetsms=3" target="_blank">
                                                    <span class="counter">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="panel info-box panel-white">
                                    <div class="panel-body">
                                        <div class="info-box-stats">
                                            <p>
                                                <a style="text-decoration: none; color: black;" href="detalhes_rpa.aspx?_scampanha=<%=_scampanha%>&_sperfil=<%=_sperfil%>&_sequipe=<%=_sequipe%>&_susuario=<%=_susuario%>&_sdtini=<%=_sdtini%>&_sdtfim=<%=_sdtfim%>&_socorrencia=<%=_socorrencia%>&_scontrato=<%=_scontrato%>&_scampanhaBKO=<%=_scampanhabko%>&_sstatusbpm=-2&_sidstatusnetsms=6" target="_blank">
                                                    <span class="counter">
                                                        <asp:Label ID="lbltoterro_contrato" runat="server"></asp:Label></span>
                                                </a>
                                            </p>
                                            <span class="info-box-title">Erro - Contrato NET SMS</span>
                                        </div>
                                        <div class="info-box-icon">
                                            <i class="icon-folder"></i>
                                        </div>
