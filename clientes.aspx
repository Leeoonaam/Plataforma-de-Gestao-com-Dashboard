<%@ Page Title="Clientes | STT - GAT Link" Language="C#" AutoEventWireup="true" CodeFile="clientes.aspx.cs" MasterPageFile="~/MasterPageGATLink.master" Inherits="clientes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="page-title">
        ...
        <div class="page-breadcrumb">
            <ol class="breadcrumb">
                <li><a href="clientes.aspx">Home</a></li>
                <li class="active">Gerenciador de Clientes</li>
            </ol>
        </div>
    </div>
                ...
                <div class="panel panel-white ui-sortable-handle" style="opacity: 1;">
                    ...
                    <div class="panel-body" style="display: block;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="m-b-sm">
                                <asp:TextBox ID="txtnome_filtro" CssClass="form-control" runat="server"></asp:TextBox>    
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="m-b-sm">
                                <asp:TextBox ID="txtcpfcnpj_filtro" CssClass="form-control" runat="server"></asp:TextBox>    
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="m-b-sm">
                                    <asp:ListBox ID="cmbtipociente_filtro" runat="server" CssClass="show-tick form-control" SelectionMode="Multiple">
