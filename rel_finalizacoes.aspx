<%@ Page Title="Finalizações | STT - GAT Link" Language="C#" MasterPageFile="~/MasterPageGATLink.master" AutoEventWireup="true" CodeFile="rel_finalizacoes.aspx.cs" Inherits="rel_finalizacoes" %>
    ...
    <div class="page-title">
        ...
        <div class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="active">Finalizações Operação</li>
            </ol>
        </div>
    </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div role="tabpanel">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="active"><a href="#tab5" role="tab" data-toggle="tab" aria-expanded="true">Motivos de Finalização</a></li>
                            </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade active in" id="tab5">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <asp:Panel ID="panel_grd_finalizacoes" Width="100%" ScrollBars="Auto" Visible="true" runat="server">
                                                ...
                                                <asp:GridView ID="gdw_dados_finalizacoes" CssClass="table table-striped table-hover"
                                                    ...
                                                    Width="100%" AutoGenerateColumns="False" DataKeyNames="idcodmotivo"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="idcodmotivo" HeaderText="ID" ItemStyle-HorizontalAlign="Left" />
                                                        <asp:BoundField DataField="Motivo" HeaderText="Finalização" ItemStyle-HorizontalAlign="Left" />
                                                        <asp:BoundField DataField="TMA" HeaderText="T.M.O." ItemStyle-HorizontalAlign="Left" />
                                                        ...
                                                        <asp:BoundField DataField="total_geral" HeaderText="Total_Geral" ItemStyle-HorizontalAlign="Left" />
                                                        <asp:BoundField DataField="tma_total" HeaderText="TMA_Geral" ItemStyle-HorizontalAlign="Left" />
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div id="div_graf_finalizacoes" style="height: 400px; width: 100%;"></div>
                                        </div>
                                    </div>
