<%@ Page Language="C#" AutoEventWireup="true" CodeFile="perfis_dados.aspx.cs" Inherits="perfis_dados" %>
...
<head id="Head1" runat="server">
    <title>Dados do Perfil | STT - GAT Link</title>
...
<body>
    ...
    <form id="frmdetalhes" runat="server">
        ...
        <div class="page-title">
            <h3 style="color:white">Dados do Perfil</h3>
        </div>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body" style="border-radius:10px; box-shadow: 0px 0px 1em #BBC0C8">
                    ...
                    <div class="form-group">
                        <label>Perfil: *</label>
                        <asp:TextBox ID="txtperfil" CssClass="form-control" runat="server"></asp:TextBox>
                    </div>

                    <div class="form-group">
                        <label>Permissão:</label>
                        <asp:ListBox ID="cmbpermissao" runat="server" CssClass="show-tick form-control" SelectionMode="Single" ></asp:ListBox>
                    </div>
