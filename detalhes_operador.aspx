<%@ Page Language="C#" AutoEventWireup="true" CodeFile="detalhes_operador.aspx.cs" Inherits="detalhes_operador" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Detalhes | STT GAT Link</title>
                        ...
                        <asp:Panel ID="panel_dados" Width="100%" ScrollBars="Auto" runat="server">
                            <asp:GridView ID="gdw_dados" CssClass="table table-striped table-bordered table-hover"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="ATENDIDAS" HeaderStyle-Width="100px" HeaderText="Atendidas" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="REGISTRADAS" HeaderText="Registradas" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="perc_REGISTRADAS" HeaderText="%" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="REGISTRADASLEAD" HeaderText="Registradas Lead" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="perc_REGISTRADASLEAD" HeaderText="%" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="REGISTRADASGERAL" HeaderText="Registradas Geral" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="perc_REGISTRADASGERAL" HeaderText="%" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="NAOREGISTRADAS" HeaderText="Não Registradas" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="perc_NAOREGISTRADAS" HeaderText="%" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="TMO" HeaderStyle-Width="100px" HeaderText="T.M.O." ItemStyle-HorizontalAlign="Left" />
