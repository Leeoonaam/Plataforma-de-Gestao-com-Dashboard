<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DetalhesFotosVendaPoint.aspx.cs" Inherits="DetalhesFotosVendaPoint" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Detalhes Venda - Fotos Point</title>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <div class="page-title" style="background-color:#6B1846;">     
                <h3 style=" color:white;">Fotos da Venda Point</h3>
            </div>
