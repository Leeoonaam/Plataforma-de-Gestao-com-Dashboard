<%@ Page Language="C#" AutoEventWireup="true" CodeFile="detalhes_pontos.aspx.cs" Inherits="detalhes_pontos" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Detalhes Pontos de Proximidade | STT GAT Link</title>
...
<body>
    ...
    <form id="frmdetalhes" runat="server">
        ...
        <div class="page-title" style="background-color:#6B1846;">
            <h3 style=" color:white;">Detalhes dos Pontos de Proximidade</h3>
        </div>
                        ...
                        <asp:Panel ID="panel_grd_dados" Width="100%" Height="500px" ScrollBars="Auto" Visible="true" runat="server">
                            ...
                            <asp:GridView ID="gdw_dados" CssClass="table table-striped table-bordered table-hover"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Grupo" HeaderText="Grupo Ponto" ItemStyle-HorizontalAlign="Left" />
                                    ...
                                    <asp:BoundField DataField="Acao" HeaderText="Ação Ponto" ItemStyle-HorizontalAlign="Left" />
